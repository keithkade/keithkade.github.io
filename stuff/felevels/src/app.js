...
const CHAR_BASE_STATS = [
  "Eliwood,Lord,1,18,5,5,7,7,5,0,7,5,, C",
  "Lowen,Cavalier,2,23,7,5,7,3,7,0,10,7,, D, D",
  "Marcus,Paladin,1,31,15,15,11,8,10,8,11,8,, A, A,  B",
  "Rebecca,Archer,1,17,4,5,6,4,3,1,5,5,, D",
  "Dorcas,Fighter,3,30,7,7,6,3,3,0,14,5,, C",
  "Bartre,Fighter,2,29,9,5,3,4,4,0,13,5,, D",
  "Hector,Lord,1,19,7,4,5,3,8,0,13,5,, C",
  "Oswin,Knight,9,28,13,9,5,3,13,3,14,4,, B",
  "Serra,Cleric,1,17,2,5,8,6,2,5,4,5,, D",
  "Matthew,Thief,2,18,4,4,11,2,3,0,7,6,, D",
  "Guy,Myrmidon,3,21,6,11,11,5,5,0,5,5,, C",
  "Guy HM,Myrmidon,3,25,8,13,13,5,6,1",
  "Merlinus,Transporter,5,18,0,4,5,12,5,2,25,0,,–",
  "Erk,Mage,1,17,5,6,7,3,2,4,5,5,, D",
  "Priscilla,Troubadour,3,16,6,6,8,7,3,6,4,7,, C",
  "Lyn,Lord,4,18,5,10,11,5,2,0,5,5,, C",
  "Wil,Archer,4,21,6,5,6,7,5,1,6,5,, D",
  "Kent,Cavalier,5,23,8,7,8,4,6,1,9,7,, D, D",
  "Sain,Cavalier,4,22,9,5,7,5,7,0,9,7,, D, D",
  "Florina,Pegasus Knight,3,18,6,8,9,8,4,5,4,7,, D",
  "Raven,Mercenary,5,25,8,11,13,2,5,1,8,5,, C",
  "Raven HM,Mercenary,5,29,10,13,15,2,6,2",
  ...
  "Legault HM,Thief,12,29,8,13,17,10,8,4",
  ...
  "Heath HM,Wyvern Rider,7,32,13,10,9,7,11,2",
  "Rath,Nomad,9,27,9,10,11,5,8,2,7,7,, B",
  "Hawkeye,Berserker,4,50,18,14,11,13,14,10,16,6,, A",
  "Geitz,Warrior,3,40,17,12,13,10,11,3,13,6,, B, B",
  "Geitz HM,Warrior,3,44,19,13,14,10,12,4",
  "Wallace,General,1,34,16,9,8,10,19,5,15,5,, A, E",
  "Farina,Pegasus Knight,12,24,10,13,14,10,10,12,5,7,, A",
  "Pent,Sage,6,33,18,21,17,14,11,16,8,6,, A, A",
  "Louise,Sniper,4,28,12,14,17,16,9,12,6,6,, A",
  "Karel,Swordmaster,8,31,16,23,20,15,13,12,9,6,, A",
  "Harken,Hero,8,38,21,20,17,12,15,10,11,6,, B, B",
  "Harken HM,Hero,8,42,23,22,18,12,16,11",
  "Nino,Mage,5,19,7,8,11,10,4,7,3,5,, C",
  "Jaffar,Assassin,13,34,19,25,24,10,15,11,8,6,, A",
  "Vaida,Wyvern Lord,9,43,20,19,13,11,21,6,12,8,, A, A",
  "Vaida HM,Wyvern Lord,9,47,22,21,14,11,22,7",
  "Nils,Bard,1,14,0,0,12,10,5,4,4,5,,–",
  "Karla,Swordmaster,5,29,14,21,18,16,11,12,7,6,, A",
  "Renault,Bishop,16,43,12,22,20,10,15,18,9,6,, A, A",
  "Athos,Archsage,20,40,30,24,20,25,20,28,9,6,, S S  S  S"
]

// Name,HP,S/M,Skl,Spd,Lck,Def,Res
const CHAR_GROWTH_STATS = [
  ...
  "Wil,75,50,50,40,40,20,25",
  "Dorcas,80,60,40,20,45,25,15",
  "Serra,50,50,30,40,60,15,55",
  "Erk,65,40,40,50,30,20,40",
  "Rath,80,50,40,50,30,10,25",
  "Matthew,75,30,40,70,50,25,20",
  "Wallace,70,45,40,20,30,35,35",
  "Lowen,90,30,30,30,50,40,30",
  "Rebecca,60,40,50,60,50,15,30",
  "Marcus,65,30,50,25,30,15,35",
  "Bartre,85,50,35,40,30,30,25",
  "Oswin,90,40,30,30,35,55,30",
  "Guy,75,30,50,70,45,15,25",
  "Guy HM,75,30,50,70,45,15,25",
  "Merlinus,120,0,90,90,100,30,15",
  "Priscilla,45,40,50,40,65,15,50",
  "Raven,85,55,40,45,35,25,15",
  "Raven HM,85,55,40,45,35,25,15",
  "Lucius,55,60,50,40,20,10,60",
  "Canas,70,45,40,35,25,25,45",
  "Dart,70,65,20,60,35,20,15",
  "Fiora,70,35,60,50,30,20,50",
  "Legault,60,25,45,60,60,25,25",
  "Legault HM,60,25,45,60,60,25,25",
  "Nils,85,5,5,70,80,30,70",
  "Ninian,85,5,5,70,80,30,70",
  "Isadora,75,30,35,50,45,20,25",
  "Heath,80,50,50,45,20,30,20",
  "Heath HM,80,50,50,45,20,30,20",
  "Hawkeye,50,40,30,25,40,20,35",
  "Geitz,85,50,30,40,40,20,20",
  "Geitz HM,85,50,30,40,40,20,20",
  "Farina,75,50,40,45,45,25,30",
  "Pent,50,30,20,40,40,30,35",
  "Louise,60,40,40,40,30,20,30",
  "Karel,70,30,50,50,30,10,15",
  "Harken,80,35,30,40,20,30,25",
  "Harken HM,80,35,30,40,20,30,25",
  "Nino,55,50,55,60,45,15,50",
  "Jaffar,65,15,40,35,20,30,30",
  "Vaida,60,45,25,40,30,25,15",
  "Vaida HM,60,45,25,40,30,25,15",
  "Karla,60,25,45,55,40,10,20",
  "Renault,60,40,30,35,15,20,40",
  "Athos,0,0,0,0,0,0,0"
]
...
const buildCharacter = (baseStatsStr) => {
  ...
  const growthRates = CHAR_GROWTH_STATS.find(str => str.startsWith(charName))?.split(',').map(rateStr => Number(rateStr) / 100);
  const classArr = CLASSES[charName];

  if (!growthRates) {
    console.log('whoops no growth rate', { baseStatsStr });
    return;
  }

  if (!classArr) {
    console.log('whoops no class', { baseStatsStr });
    return;
  }
  ...
  if (!gains) {
    console.log('whoops no promotion gains', { baseStatsStr });
    gains = [0,0,0,0,0,0,0];
  }
  ...
  if (!statCaps) {
    console.log('whoops no stat caps', { baseStatsStr });
    return;
  }
  ...
  allCharStats[charName] = {
    ...
    attributes: [
      { name: 'HP',  base: Number(stats[3]), growth: growthRates[1], cap: [60, statCaps[0]], promote: gains[0] },
      { name: 'Str', base: Number(stats[4]), growth: growthRates[2], cap: [20, statCaps[1]], promote: gains[1] },
      { name: 'Skl', base: Number(stats[5]), growth: growthRates[3], cap: [20, statCaps[2]], promote: gains[2] },
      { name: 'Spd', base: Number(stats[6]), growth: growthRates[4], cap: [20, statCaps[3]], promote: gains[3] },
      { name: 'Lck', base: Number(stats[7]), growth: growthRates[5], cap: [30, statCaps[4]], promote: 0 },
      { name: 'Def', base: Number(stats[8]), growth: growthRates[6], cap: [20, statCaps[5]], promote: gains[4] },
      { name: 'Res', base: Number(stats[9]), growth: growthRates[7], cap: [20, statCaps[6]], promote: gains[5] },
    ]
  }
}
    ...
    <div className="character">
      <div className="character__info">
        ...
        <div className="character__desc">
          ...
          <div>Class:{' '}
            {character.promoted ?
              <span className="bold">{character.class[0]}</span>
              :
              <>
                <span className={promoted ? '' : 'bold'}>{character.class[0]}</span> &rarr; <span className={promoted ? 'bold' : ''}>{character.class[1]}</span>
              </>
            }
          </div>
          <div>Total Levels: {lvl} (before promotion + after promotion)</div>
          {!character.promoted && <div>Promoted at level: {promoted ? lvlPromotedAt : 'NA'}</div>}
      ...
      <div className="character__stats">
        ...
        <div className="level_controls">
          ...
          {character.promoted ?
            ...
            :
            <input
              style={{width: `${(19 + lvlPromotedAt)/2}rem`}}
              type="range"
              min={1}
...
const CharacterSelect = ({ setCharacter }) =>
  <div>
    ...
    {Object.keys(allCharStats).map(name =>
      <button key={name} onClick={() => setCharacter(name)} className="character_select_btn">
        <img alt="" src={allCharStats[name].img} />
        <p>{name}</p>
      </button>
    )}
  </div>
...
const App = () => {
  ...
  return (
    <div>
      <h1>Fire Emblem 7 Level Up Simulator</h1>
      {character && <Character character={allCharStats[character]} reset={() => setCharacter(null)}/>}
      ...
      <div className="instructions">
        ...
        Then you can use change the level to simulate your character's growth. As they level up, the tool simulates leveling up according to the characters stat growth chances.
